...
void renderSDF(Bitmap<FloatRGBA> &output, const Bitmap<float> &sdf, double pxRange = 0);
void renderSDF(Bitmap<float> &output, const Bitmap<FloatRGBA> &sdf, double pxRange = 0);
void renderSDF(Bitmap<FloatRGBA> &output, const Bitmap<FloatRGBA> &sdf, double pxRange = 0);
